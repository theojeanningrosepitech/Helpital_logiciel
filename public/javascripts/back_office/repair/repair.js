function initRepairList() {
    websocket.addEventListener('repair', 'new', (message) => {

        fetch('/back_office/repairs/fragment?id=' + message.identifiers.id).then(function(response) {
    ...
    websocket.addEventListener('repair', 'update', (message) => {
    ...
    websocket.addEventListener('repair', 'delete', (message) => {
